 ...
 * @author Dixson
 */
public class VRegistrarPersona extends javax.swing.JDialog {

    /**
     * Creates new form Jframe_NUEVOFUNCIONARIO
     */
    public VRegistrarPersona(JFrame v, boolean modal) {
        super(v, modal);
    ...
    private void initComponents() {
        ...
        primernombre.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        segundonombre.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        primerapellido.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        segundoapellido.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        cedula.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        cedula.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                cedulaKeyTyped(evt);
            }
        });
        jPanel2.add(cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 90, 150, 20));

        parroquia.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        parroquia.setForeground(new java.awt.Color(102, 102, 102));
        parroquia.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        lugarnacimiento.setFont(new java.awt.Font("Rockwell", 0, 12)); // NOI18N
        lugarnacimiento.setForeground(new java.awt.Color(102, 102, 102));
        lugarnacimiento.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        tituloobtenido1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        tituloobtenido2.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        telefono1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        telefono2.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        municipio.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        correo.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        fechanacimiento.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        fechanacimiento.setForeground(new java.awt.Color(102, 102, 102));
        fechanacimiento.setDateFormatString("dd-MM-yyyy");
        jPanel2.add(fechanacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, 150, -1));

        noCedula.setBackground(new java.awt.Color(255, 255, 255));
        noCedula.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        noCedula.setText("NO POSEE");
        noCedula.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                noCedulaMouseClicked(evt);
            }
        });
        jPanel2.add(noCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 90, -1, -1));
        ...
        estado.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        gruposanguineo.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(204, 204, 204)));
        ...
        BTN_REGISTRARPERSONA.setBackground(new java.awt.Color(102, 102, 102));
        BTN_REGISTRARPERSONA.setForeground(new java.awt.Color(255, 255, 255));
        BTN_REGISTRARPERSONA.setText("REGISTRAR");
        BTN_REGISTRARPERSONA.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jPanel1.add(BTN_REGISTRARPERSONA, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 670, 160, 30));
    ...
    private void noCedulaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_noCedulaMouseClicked
        if(noCedula.isSelected()){
            cedula.setEnabled(false);
        }else{
            cedula.setEnabled(true);
        }
    }//GEN-LAST:event_noCedulaMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VRegistrarPersona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private view.componentes.BTN BTN_REGISTRARPERSONA;
    ...
    private javax.swing.JCheckBox noCedula;
