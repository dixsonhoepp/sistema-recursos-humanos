 ...
 * @author Dixson
 */
public class VRegistrarReposos extends javax.swing.JDialog {
    
    public static int modo;


    public VRegistrarReposos(JDialog v, boolean modal) {
        super(v, modal);
    ...
    private void initComponents() {
        ...
        jPanel1.add(departamento, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 70, 90, 20));
        ...
        jPanel1.add(jefe, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 180, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VRegistrarReposos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
