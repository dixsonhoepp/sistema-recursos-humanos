 ...
 */
package view.funcionarios.reportePDF;
 ...
 * @author Dixson
 */
public class VFechaReporte extends javax.swing.JDialog {

    public static int modo;
    private int opcion;

    public VFechaReporte(JFrame v, boolean modal) {
    ...
    public VFechaReporte(JDialog v, boolean modal) {
    ...
    private void initComponents() {
        ...
        btnArchivo = new view.componentes.BTN();
        ...
        jPanel1.add(fecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, -1, -1));

        btnArchivo.setBackground(new java.awt.Color(102, 102, 102));
        btnArchivo.setForeground(new java.awt.Color(255, 255, 255));
        btnArchivo.setText("Archivo");
        btnArchivo.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jPanel1.add(btnArchivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, 160, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VFechaReporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private view.componentes.BTN btnArchivo;
