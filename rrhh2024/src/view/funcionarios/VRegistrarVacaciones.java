 ...
 * @author Dixson
 */
public class VRegistrarVacaciones extends javax.swing.JDialog {
    
    public static int modo;


    public VRegistrarVacaciones(JDialog v, boolean modal) {
        super(v, modal);
    ...
    private void initComponents() {
        ...
        periodo.setForeground(new java.awt.Color(102, 102, 102));
        periodo.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(102, 102, 102)));
        periodo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                periodoKeyReleased(evt);
            }
        });
        jPanel1.add(periodo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 100, 20));
        ...
        jLabel8.setText("- DIAS HABILES:");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 80, 20));
        ...
        jPanel1.add(dias, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 40, 20));

        jLabel9.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(51, 51, 51));
        jLabel9.setText("- JEFE INMEDIATO:");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 100, 20));
        ...
        jPanel1.add(jefe, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 100, 130, 20));
    ...
    private void periodoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_periodoKeyReleased
        TextoMayuscula texto = new TextoMayuscula(periodo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VRegistrarVacaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
