 ...
 * @author Dixson
 */
public class VAprobado extends javax.swing.JDialog {

    /**
     * Creates new form Jframe_EXITO
     */
    public VAprobado(JFrame v, boolean modal) {
        super(v, modal);
        try {
    ...
    public VAprobado(JDialog v, boolean modal) {
        super(v, modal);
        try {
            UIManager.setLookAndFeel(new FlatLightLaf());
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/img/icons8_ok_60px.png"))); // NOI18N
        ...
        jPanel1.add(BTN_ACEPTAR, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VAprobado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
