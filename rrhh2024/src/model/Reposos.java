...
public class Reposos {
    ...
    public void Registrar(int id, String motivo, String departamento, String dias,
        ...
        String sql = "INSERT INTO Reposos (motivo, departamento, dias, jefe, fechasalida, fecharegreso, idfuncionario) "
                + "VALUE (?,?,?,?,?,?,?)";
    ...
    public void Eliminar(int id) {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("DELETE FROM Reposos WHERE IDReposos = ?");
            ps.setInt(1, id);
            ps.executeUpdate();
            con.close();
    ...
    public DefaultTableModel Listado(int IdFuncionario) {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM Reposos WHERE IDFuncionario = ? ORDER BY FechaSalida DESC");
            ...
            while (rs.next()) {
                ...
                datos[7] = rs.getString("IDReposos");
