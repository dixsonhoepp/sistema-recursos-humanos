...
public class Vacaciones {
    ...
    //Registrar 
    public void Registrar(int id, String periodo, String departamento, String dias,
            String jefeInmediato, String fechaSalida, String fechaRegreso) throws SQLException {

        String sql = "INSERT INTO Vacaciones (periodo, departamento, dias, jefe, "
                + "fechasalida, fecharegreso, idfuncionario) "
                + "VALUE (?,?,?,?,?,?,?)";
        
        PreparedStatement ps = con.prepareStatement(sql);
        ps.setString(1, periodo.toUpperCase());
    ...
    public void Eliminar(int id) {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("DELETE FROM Vacaciones WHERE IDVacaciones = ?");
            ps.setInt(1, id);
            ps.executeUpdate();
            con.close();
    ...
    public DefaultTableModel Listado(int IdFuncionario) {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("SELECT * FROM Vacaciones WHERE IDFuncionario = ? ORDER BY FechaSalida DESC");
            ...
            while (rs.next()) {
                ...
                datos[1] = rs.getString("Periodo").toUpperCase();
                ...
                datos[7] = rs.getString("IDVacaciones");
